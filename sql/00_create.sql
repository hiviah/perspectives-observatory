...
DROP TABLE IF EXISTS ee_certs_x_ca_certs;
...
-- Defines certificate chains; order of chains is given by id of (ee_cert_id,
-- ca_cert_id) pairs. Higher id means closer to chain root.
CREATE TABLE ee_certs_x_ca_certs (
    id serial PRIMARY KEY,
...
CREATE INDEX ee_certs_x_ca_certs_service_id_idx ON ee_certs_x_ca_certs (ee_cert_id);
